...
public class FileHelper extends Base {
     ...
     */
    public void uploadFile(String inputXpath, String fileDirectory, String uploadButtonXpath, String conditionXpath, WebDriver driver) throws InterruptedException {
